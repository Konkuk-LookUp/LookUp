...
class ClosetFragment : Fragment() {
    ...
    private fun initData() {
        data.add(MyCloth(R.drawable.cloth_example,"갈색 긴팔 셔츠"))
        data.add(MyCloth(R.drawable.cloth_example,"회색 긴팔 셔츠"))
        data.add(MyCloth(R.drawable.cloth_example,"베이지색 폴로 셔츠"))
        data.add(MyCloth(R.drawable.cloth_example,"하늘색 하와이안 셔츠"))
    }
